...
public abstract class CommandActionAddCondition extends CommandActionAdd {
    ...
    public static class Item extends CommandActionAddCondition {
        ...
        @Override
        public me.mrdaniel.npcs.data.npc.actions.conditions.Condition createCondition(final CommandContext args) {
            return new ConditionItem(args.<ItemType>getOne("type").get(), args.<Integer>getOne("amount").get(), args.<String>getOne("name").orElse(null));
        }
    }
